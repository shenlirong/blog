...
<img src="@source/code/JavaScript与TypeScript/image/2.png" alt="alt text" loading="lazy"></p>
<p><strong>这里需要特别说明一下，对于对象（引用对象）类型的判断往往并不是我们想要的结果，换句话说，就是我只知道他是对象类型，但是不知道是什么对象，比如：</strong><br>
<img src="@source/code/JavaScript与TypeScript/image/3.png" alt="alt text" loading="lazy"><br>
...
<img src="@source/code/JavaScript与TypeScript/image/4.png" alt="alt text" loading="lazy"><br>
...
<img src="@source/code/JavaScript与TypeScript/image/5.png" alt="alt text" loading="lazy"><br>
...
<img src="@source/code/JavaScript与TypeScript/image/6.png" alt="alt text" loading="lazy"><br>
