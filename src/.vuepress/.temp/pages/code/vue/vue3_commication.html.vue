<template><div><!-- more -->
<h1 id="vue组件通信方式" tabindex="-1"><a class="header-anchor" href="#vue组件通信方式"><span>Vue组件通信方式</span></a></h1>
<p><strong>Vue2组件之间的通信方式</strong>：<br>
1.<strong>props</strong>:可以实现父子组件、字父组件、甚至兄弟组件通信<br>
...
<p><strong>Vue3组件之间的通信方式</strong>：<br>
1.<strong>props</strong>:可以实现父子组件、字父组件、甚至兄弟组件通信<br>
2.<strong>自定义事件</strong>:可以实现子父组件通信<br>
3.<strong>插件mitt</strong>:可以实现任意组件通信<br>
4.<strong>pubsub</strong>:发布订阅模式实现任意组件通信<br>
5.<strong>pinia</strong>:集中式状态管理容器，实现任意组件通信<br>
6.<strong>ref</strong>:父组件获取子组件实例，获取子组件的响应式数据以及方法<br>
7.<strong>slot</strong>：插槽（默认插槽、具名插槽、作用于插槽）实现父子组件通信<br>
8.<strong>provide/inject</strong>:提供注入</p>
...
<div class="language- line-numbers-mode has-collapsed-lines collapsed" data-highlighter="shiki" data-ext="" style="--vp-collapsed-lines:15;--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code class="language-"><span class="line"><span>&#x3C;template></span></span>
...
<p>在Vue3中可以利用useAttrs方法获取组件的属性与事件(包含:原生DOM事件或者自定义事件),次函数功能类似于Vue2框架中<span v-pre class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML"><semantics><mrow><mi>a</mi><mi>t</mi><mi>t</mi><mi>r</mi><mi>s</mi><mtext>属性与</mtext></mrow><annotation encoding="application/x-tex">attrs属性与</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:0.6833em;"></span><span class="mord mathnormal">a</span><span class="mord mathnormal">tt</span><span class="mord mathnormal">rs</span><span class="mord cjk_fallback">属性与</span></span></span></span>listeners方法。</p>
...
<span class="line"><span>&#x3C;style scoped></span></span>
<span class="line"><span>&#x3C;/style></span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div><div class="collapsed-lines"></div></div><p><strong>作用域插槽</strong></p>
...
<span class="line"><span>&#x3C;style scoped></span></span>
<span class="line"><span>&#x3C;/style></span></span></code></pre>
<div class="line-numbers" aria-hidden="true" style="counter-reset:line-number 0"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div><div class="collapsed-lines"></div></div><p>父组件内部代码如下:</p>
<div class="language- line-numbers-mode has-collapsed-lines collapsed" data-highlighter="shiki" data-ext="" style="--vp-collapsed-lines:15;--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34"><pre class="shiki shiki-themes one-light one-dark-pro vp-code" v-pre=""><code class="language-"><span class="line"><span>&#x3C;template></span></span>
<span class="line"><span>  &#x3C;div></span></span>
<span class="line"><span>    &#x3C;h1>slot&#x3C;/h1></span></span>
